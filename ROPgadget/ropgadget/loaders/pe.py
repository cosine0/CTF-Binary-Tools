...
class PE:
    ...
    def __parseOptHeader(self):
        PEoptHeader = self.__binary[
                      self.__PEOffset + 24:self.__PEOffset + 24 + self.__IMAGE_FILE_HEADER.SizeOfOptionalHeader]
        ...
        for section in self.__sections_l:
            if section.Characteristics & 0x80000000:
                ret += [{
                    ...
                    "opcodes": str(
                        self.__binary[section.PointerToRawData:section.PointerToRawData + section.SizeOfRawData])
                }]
        return ret
    ...
    def getArch(self):
        if self.__IMAGE_FILE_HEADER.Machine == PEFlags.IMAGE_MACHINE_INTEL_386 \
